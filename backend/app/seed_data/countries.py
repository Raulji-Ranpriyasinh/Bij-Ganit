"""ISO 3166 country seed data (246 rows).

Mirrors the reference Laravel `CountriesTableSeeder`.  The data is
factual (ISO 3166 code, country name, E.164 phone prefix) so we keep
the original ids to make referential changes predictable.
"""
